...
cfg.DATASET_DIR = r"\\data" # Root folder of your dataset
...
cfg.INFERENCE_OUTPUT_DIR_RGB = os.path.join(cfg.DATASET_DIR, "inference_output_rgb") 
...
cfg.PERTURBED_MASKS_DIR = os.path.join(cfg.DATASET_DIR, "masks_perturbed", "id",  "p_0.50") # Required for benchmarking

# Paths to store intermediate results. Only the root has to be set
cfg.BASE_OUTPUT_DIR = "output\\Automatic-Label-Error-Detection_permuted_0.50"
cfg.INTERMEDIATE_DIR = os.path.join(cfg.BASE_OUTPUT_DIR, "intermediate_results") 
cfg.COMPONENTS_DIR = os.path.join(cfg.INTERMEDIATE_DIR, "components")  
cfg.METRICS_DIR = os.path.join(cfg.INTERMEDIATE_DIR, "metrics")  
# Visualization paths
cfg.VISUALIZATIONS_DIR = os.path.join(cfg.BASE_OUTPUT_DIR, "visualizations") 
...
cfg.CLASS_IDS = [6, 7, 11, 12, 13, 14, 15, 17, 18] # Class ids of classes in which we search for label errors.
#E.g. Carla [2, 7, 9, 13] Cityscapes [6, 7, 11, 12, 13, 14, 15, 17, 18] #Pascal list(range(1, 21)) 
# #Coco list(range(1, 93)) 
...
# True if you want to visualize the evaluated label errors
cfg.VISUALIZE_EVALUATED = True